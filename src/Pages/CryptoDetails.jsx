...
import { BsGithub, BsReddit, BsTelegram } from "react-icons/bs";
  ...
  return (
    <>
    {
      coinDetail?.uuid === coinId.coinId ? (
          ...
          <div className='card coin-card'>
            <div className='d-flex justify-content-center gap-4 align-item-center'>
              ...
              <div className='align-self-center'>
                ...
                <h5>
                  <div className="grow-box"><span className="badge rounded-pill bg-success">
                    <CgArrowUp />
                    +1.06%</span></div>
                </h5>
              </div>
            ...
            <div className='align-self-center'>
              <div className='text-end'>
                <h4 className='fw-semibold mb-3'>PR : 24569.472111</h4>
                <div className='d-flex gap-3 justify-content-center align-item-center'>
                  {/* {
                    coinDetail.links ? coinDetail.links.map((item) => {
                  ...
                  <div className='link-icon small'><a href='https://bitcoin.org' target="_blank"><AiOutlineLink /></a></div>
                  <div className='link-icon small'><a href='https://bitcoin.org' target="_blank"><BiBitcoin /></a></div>
                  <div className='link-icon'><a href='https://bitcoin.org' target="_blank"><SiInternetexplorer /></a></div>
                  <div className='link-icon'><a href='https://bitcoin.org' target="_blank"><BsGithub /></a></div>
                  <div className='link-icon'><a href='https://bitcoin.org' target="_blank"><BsReddit /></a></div>
                  <div className='link-icon'><a href='https://bitcoin.org' target="_blank"><BsTelegram /></a></div>
                  <div className='link-icon'><a href='https://bitcoin.org' target="_blank"><GiWhiteBook /></a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='col-6'>
          <div className='common-card card'>
            <h5 className="my-0">Exchanges to buy Ethereum</h5>
            <hr />
            <div className=''>
             <ExchangeToBuy />
            </div>
